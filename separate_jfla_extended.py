"""Demucs vocal separation for extended JFla audio files"""
import os
import subprocess

input_dir = r"C:\Users\thtgg\workspace2\GPT-SoVITS\jfla_audio_extended"
output_dir = r"C:\Users\thtgg\workspace2\GPT-SoVITS\jfla_vocals_extended"
...
for i, f in enumerate(wav_files, 1):
    ...
    cmd = [
        "C:\\Users\\thtgg\\workspace2\\GPT-SoVITS\\.venv\\Scripts\\python.exe",
        "-m", "demucs",
        "--two-stems", "vocals",
        "-n", "htdemucs",
