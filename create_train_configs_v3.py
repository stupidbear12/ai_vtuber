"""Create SoVITS and GPT training configs for sion_jfla_v3"""
import os
import json
import yaml
...
tmp_s2 = os.path.join(GPT_SOVITS_DIR, "TEMP", "tmp_s2_jfla_v3.json")
...
tmp_s1 = os.path.join(GPT_SOVITS_DIR, "TEMP", "tmp_s1_jfla_v3.yaml")
