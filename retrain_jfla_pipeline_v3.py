"""Full preprocessing pipeline for JFla v3 (13 originals).
Steps: slice → ASR → 1-get-text → 2-get-hubert-wav32k → 3-get-semantic
"""
import os
import sys
import shutil
...
EXP_NAME = "sion_jfla_v3"
VOCALS_DIR = os.path.join(GPT_SOVITS_DIR, "jfla_vocals_v3")
SLICED_DIR = os.path.join(GPT_SOVITS_DIR, "jfla_sliced_v3")
ASR_DIR = os.path.join(GPT_SOVITS_DIR, "jfla_asr_v3")
...
# Find and filter the generated list file
...
if list_files:
    ...
    filtered_file = os.path.join(ASR_DIR, "jfla_sliced_v3_filtered.list")
